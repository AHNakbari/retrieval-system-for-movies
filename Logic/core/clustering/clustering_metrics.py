...
# def silhouette_score(embeddings: List, cluster_labels: List) -> float:
#     """
...
def purity_score(true_labels: List, cluster_labels: List) -> float:
    """
...
# def adjusted_rand_score(true_labels: List, cluster_labels: List) -> float:
#     """
