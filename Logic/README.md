...
## 1. [Crawler](core/crawler/crawler.py)

In the beginning, we need to crawl our required data and create a dataset for our needs. For this sake, we implement a [crawler](core/crawler/crawler.py). The structure and functions required for this part, are explained in the `crawler.py` file.
...
## 2. [Near-duplicate page detecion](core/lsh/LSH.py)
...
## 3. [Preprocess](core/preprocess/preprocess.py)
